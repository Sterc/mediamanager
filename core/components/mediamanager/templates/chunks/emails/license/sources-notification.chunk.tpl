        ...
        <tr>
            <td style="width: 100%; text-align: center;">
                ...
                <table cellpadding="20" cellspacing="0" border="0" width="600" style="font-family: Arial, sans-serif; font-size: 15px; line-height: 21px; color: #333; background-color: #fff; text-align: left; margin: 0 auto;">
                    <tr>
                        <td>
                            <h2>[[%mediamanager.license.email.image_source_validity.title]]</h2>
                            <p>[[%mediamanager.license.email.image_source_validity.msg]]</p>

                            [[+expiredItems:notempty=`
                                <h3 style="color: #FC2E20;margin-bottom: 5px;">[[%mediamanager.license.email.expired_sources.title]]</h3>
                                <p style="margin: 0 0 5px 0;">[[%mediamanager.license.email.expired_sources.msg]]</p>
                                <table width="100%" style="border-collapse: collapse;border: thin solid #f3f3f3;">
                                    <tbody>
                                        <tr style="background:#428bca;color:#fff;">
                                            <th style="padding: 5px;">[[%mediamanager.license.email.source]]</th>
                                        </tr>
                                        [[+expiredItems]]
                                    </tbody>
                                </table>
                            ...
                            [[+notifyItems:notempty=`
                                <h3 style="margin-bottom: 5px;">[[%mediamanager.license.email.about_to_expire_sources.title]]</h3>
                                <p style="margin: 0 0 5px 0;">[[%mediamanager.license.email.about_to_expire_sources.msg]]</p>
                                <table width="100%" style="border-collapse: collapse;border: thin solid #f3f3f3;">
                                    <tbody>
