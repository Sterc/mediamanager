...
$_lang['mediamanager.files.dropzone_maximum_upload_size'] = 'Maximum upload file size: %s.';
$_lang['mediamanager.files.dropzone_button'] = 'Or select files';
$_lang['mediamanager.files.dropzone_title'] = 'Drop files here to upload';
